"""
tsne_umap.py — Visualize embeddings with t-SNE and UMAP.

Usage:
  python tsne_umap.py --data_dir data/processed --split train --sample 1000 \
      --perplexity 30 --n_neighbors 15 --min_dist 0.1

Saves PNGs under data/processed/visualizations
"""
import os
import argparse
import numpy as np
